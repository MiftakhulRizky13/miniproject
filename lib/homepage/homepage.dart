              ...
              return AlertDialog(
                              ...
                              child: TextFormField(
                                ...
                                validator: (text) {
                                  if (text == null || text.isEmpty) {
                                    return 'Masukkan Jumlah uangnya';
                                  }
                                  return null;
                                },
                        ...
                        children: [
                          Expanded(
                            child: TextField(
                              decoration: InputDecoration(
                                border: OutlineInputBorder(),
                                hintText: 'Uang digunakan untuk apa/darimana?',
                              ),
                ...
                actions: <Widget>[
                  MaterialButton(
                    ...
                    child:
                        Text('Batalkan', style: TextStyle(color: Colors.white)),
                    onPressed: () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text('Income & Expanses App'),
        ),
      ),
      body: Padding(
